...
int main()
{
    ...
    for (i = 0; i < width ; i++){ // spacing words improves readabilty 
        printf("*");

        for ( j = 0; j < i - 1; j++) // braces are not mendatory when there is only a single statement in the for loop
                                    // spacing words improves readabilty 
            printf(" ");
    ...
    for (i = 0; i < width; i++){
        ...
        printf("*");
        for(j = 0; j < width - 2; j++) // when there is only one statement in the for loop braces are not mendatory 
                                    // spacing words improves readabilty 
            printf(" ");
    ...
    if (width != 1){
       for ( i = 0; i < width; i++){
        ...
        if (i != width - 1) // spacing words improves readabilty 
            printf("*");
         

        for (j = 0; j < width - 2 - i; j++){ // spacing words improves readabilty 
            printf(" ");
        }
